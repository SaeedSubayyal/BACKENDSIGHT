...
class UserManager:
    ...
    async def update_user(
        ...
        for field, value in updates.items():
            ...
            elif field in admin_only_fields and admin_user and admin_user.role == UserRole.ADMIN:
                if hasattr(user, field):
                    previous_state[field] = getattr(user, field)
                    setattr(user, field, value)
    ...
    async def get_user_permissions(self, user: User) -> Dict[str, Any]:
        ...
        permissions = {
            ...
            "admin_permissions": {
                ...
                "can_view_analytics": user.role == UserRole.ADMIN,
                "can_manage_subscriptions": user.role == UserRole.ADMIN,
                "can_view_logs": user.role == UserRole.ADMIN
            }
        }
